...
class Lexer {
  ...
  bool _isReservedChar(String? char) =>
      char != null && _reservedChars.contains(char);

  bool _isWhiteSpace(String? char) =>
      char != null && _whiteSpaces.contains(char);

  bool _isTokenChar(String? char) =>
      char != null && !_nonCharTokens.contains(char);
  ...
  Attribute _parseAttrs(String str) {
    ...
    TagState nextTagState() {
      if (tagMode == TagState.attibute) {
        // Grab untill end, whitespace or end tag.
        bool validAttrName(String? char) =>
            !(char == '=' || _isWhiteSpace(char));
      ...
      bool validName(String? char) =>
          !(char == equal || _isWhiteSpace(char) || attrCharGrabber.isLast);
      ...
      return hasEq ? TagState.attibute : TagState.value;
    }
